package com.example.uma_ros2_android;
...
public class MainActivity extends ROSActivity {
    ...
    private Button Connect, SelectResolution, SelectCamera;
    ...
    public final void onCreate(Bundle savedInstanceState) {
        ...
        Connect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameCondition() && HzCondition()) { //Nombre correcto
                    ...
                    //si el usuario no introduce nada, el nombre por defecto es P40

                    // inputText is assigned in the nameCondition function.
                    // If the user does not input anything, the default name is set to "P40".
                    ...
                    text_info.setText(getInfoMessage(NodeName,AgentName,BatteryON,LocationON,IMUON,
                                                    selectedResolution,selectedCamera,
        ...
        SelectCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Se actualiza el valor de la camara seleccionada y la apariencia del botón
                // Update the value of the selected camera and the appearance of the button

                if (selectedCamera == 0){
                    selectedCamera = 4;
                    SelectCamera.setText(R.string.camera_wide_angle); //Valor con 4
                }
                else if (selectedCamera == 4) {
                    selectedCamera = 5;
                    SelectCamera.setText(R.string.camera_zoom); //Valor con 5
                }
                else if (selectedCamera == 5) {
                    selectedCamera = 0;
                    SelectCamera.setText(R.string.camera_normal); //Valor con 0
                }
    ...
    public void startCamera(int selecResolution, int selecCamera, boolean intermitent_mode) {
        ...
        listenableFuture.addListener(() -> {
            try {
                ...
                Log.d("INFO_CAMERAS", "Available cameras:" + availableCameraInfos);
                CameraSelector cameraSelector = availableCameraInfos.get(selecCamera).getCameraSelector();
    ...
    private final Runnable onMessageReceivedRunnable = new Runnable() {
        @Override
        public void run() {
            startCamera(androidNode.getResolution(),androidNode.getCamera(),androidNode.getMode());
            text_info.setText(getInfoMessage(NodeName,AgentName,
                                            BatteryON,LocationON,IMUON,
                                            androidNode.getResolution(), androidNode.getCamera(),
                                            String.valueOf(batteryHz),
                                            String.valueOf(locationHz),
                                            String.valueOf(IMUHz),
                                            androidNode.getMode()));
    ...
    private String getInfoMessage(String NodeName,String AgentName, boolean Battery, boolean Location, boolean IMU, int resolution, int camera,
        ...
        msg_info += "\nCurrent camera: " + getCameraTag(camera) + "\n";
    ...
    private String getResolutionTag(int resolution){
        ...
        if (resolution == 0){
            resolution_name = "720x720";
        } else if (resolution == 1) {
            resolution_name = "1280x720";
        } else if (resolution == 2) {
            resolution_name = "1440x720";
    ...
    private String getCameraTag(int camera){
        String camera_name = "";

        if (camera == 0){
            camera_name = "Normal";
        } else if (camera== 4) {
            camera_name = "Wide-Angle";
        } else if (camera == 5) {
            camera_name = "Zoom";
        }
        return camera_name;
    ...
    private void initializeAvailableResolutions(){
        available_resolutions[0] = new Size(720,720);
        available_resolutions[1] = new Size(1280,720);
        available_resolutions[2] = new Size(1440,720);
    ...
    private void connectToXML(){
        ...
        // Entradas de texto
        // Text inputs
        nameInput = findViewById(R.id.nameInput); //campo de texto
        batteryInput = findViewById(R.id.batteryInput);
        locationInput = findViewById(R.id.locationInput);
        IMUInput = findViewById(R.id.IMUInput);

        // Switchs
        BatterySwitch = findViewById(R.id.BatterySwitch); //switchs
    ...
    private void getAdditionalPublishers(){
        ...
        //Log.d("IMU", String.valueOf(IMUPeriod));
